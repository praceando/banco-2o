...
VALUES 
    (1, NULL, 2, 'João Silva', 'joao.silva@example.com', 'senha123', TRUE, 'Entusiasta de eventos culturais'),
    (1, NULL, 1, 'Maria Souza', 'maria.souza@example.com', 'senha456', FALSE, 'Apreciadora de gastronomia'),
    (1, NULL, 2, 'Carlos Oliveira', 'carlos.oliveira@example.com', 'senha789', TRUE, 'Amante de esportes ao ar livre'),
    (1, NULL, 1, 'Ana Lima', 'ana.lima@example.com', 'senha321', FALSE, 'Interessada em sustentabilidade'),
    (1, NULL, 2, 'Rafael Abravanel', 'rafael.costa@example.com', 'senha654', TRUE, 'Explorador de eventos tecnológicos'),
    (1, NULL, 1, 'Fernanda Alves', 'fernanda.alves@example.com', 'senha987', FALSE, 'Curiosa sobre culturas locais'),
    (1, NULL, 2, 'Gabriel Martins', 'gabriel.martins@example.com', 'senha852', TRUE, 'Participante assíduo de eventos musicais'),
    (1, NULL, 1, 'Juliana Rodrigues', 'juliana.rodrigues@example.com', 'senha741', FALSE, 'Gosta de atividades de lazer com a família'),
    (1, NULL, 2, 'Rodrigo Pereira', 'rodrigo.pereira@example.com', 'senha963', TRUE, 'Interessado em feiras de artesanato'),
    (1, NULL, 1, 'Patrícia Oliveira', 'patricia.oliveira@example.com', 'senha159', FALSE, 'Apreciadora de atividades culturais'),
    (1, NULL, 3, 'Lucas Santos', 'lucas.santos@example.com', 'senha753', TRUE, 'Focado em eventos de saúde e bem-estar'),
    (1, NULL, 1, 'Beatriz Fernandes', 'beatriz.fernandes@example.com', 'senha258', FALSE, 'Exploradora de atividades ao ar livre'),
    (2, NULL, 2, 'Felipe Andrade', 'felipe.andrade@example.com', 'senha963', TRUE, 'Organizador de eventos gastronômicos'),
    (2, NULL, 1, 'Sofia Barbosa', 'sofia.barbosa@example.com', 'senha753', FALSE, 'Especialista em eventos culturais'),
    (2, NULL, 2, 'Miguel Ferreira', 'miguel.ferreira@example.com', 'senha159', TRUE, 'Promotor de eventos esportivos'),
    (2, NULL, 1, 'Laura Moraes', 'laura.moraes@example.com', 'senha852', FALSE, 'Responsável por eventos de lazer e pets'),
    (2, NULL, 2, 'Thiago Oliveira', 'thiago.oliveira@example.com', 'senha147', TRUE, 'Organizador de eventos de dança e música'),
    (2, NULL, 1, 'Camila Silva', 'camila.silva@example.com', 'senha369', FALSE, 'Produtora de eventos familiares'),
    (2, NULL, 1, 'André Almeida', 'andre.almeida@example.com', 'senha951', TRUE, 'Focado em feiras ecológicas'),
